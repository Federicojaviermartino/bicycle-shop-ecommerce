        ...
        { id: '1', name: 'Frame', description: 'Bicycle frame types', productCategoryId: 'bicycles', isRequired: true, displayOrder: 1 },
        { id: '2', name: 'Wheels', description: 'Wheel sets and tires', productCategoryId: 'bicycles', isRequired: true, displayOrder: 2 },
        { id: '3', name: 'Chain', description: 'Drive chain options', productCategoryId: 'bicycles', isRequired: true, displayOrder: 3 },
        { id: '4', name: 'Brakes', description: 'Braking systems', productCategoryId: 'bicycles', isRequired: true, displayOrder: 4 },
        { id: '5', name: 'Finish', description: 'Paint and coating options', productCategoryId: 'bicycles', isRequired: false, displayOrder: 5 },
        ];
        const mockPartOptions: PartOption[] = [
        { id: '1', name: 'Road Frame', description: 'Lightweight racing frame', partTypeId: '1', basePrice: 800, isActive: true, inStock: true, stockCount: 15 },
        { id: '2', name: 'Mountain Frame', description: 'Full-suspension trail frame', partTypeId: '1', basePrice: 1200, isActive: true, inStock: true, stockCount: 8 },
        { id: '3', name: 'Road Wheels (700c)', description: 'Lightweight carbon wheels', partTypeId: '2', basePrice: 600, isActive: true, inStock: true, stockCount: 12 },
        { id: '4', name: 'Mountain Wheels (29")', description: 'Tubeless ready trail wheels', partTypeId: '2', basePrice: 750, isActive: true, inStock: false, stockCount: 0 },
        { id: '5', name: 'Standard Chain', description: '11-speed chain', partTypeId: '3', basePrice: 120, isActive: true, inStock: true, stockCount: 25 },
        { id: '6', name: 'High-Performance Chain', description: 'Ceramic bearing chain', partTypeId: '3', basePrice: 280, isActive: true, inStock: true, stockCount: 5 },
        ];
        ...
        const handleSubmit = (e: React.FormEvent) => {
            e.preventDefault();
            if (editingOption) {
            setPartOptions(prev => prev.map(option => 
        ...
        const handleToggleActive = (option: PartOption) => {
            setPartOptions(prev => prev.map(opt => 
            opt.id === option.id 
                ...
                <table className="admin-table">
                    ...
                    {filteredOptions.map(option => (
                        ...
                        <td>
                            ...
                            <span className={`admin-table__stock-badge ${option.inStock ? 'in-stock' : 'out-of-stock'}`}>
                        ...
                        <td>
                            <span className={`admin-table__status-badge ${option.isActive ? 'active' : 'inactive'}`}>
            ...
            <div className="admin-content__body">
                ...
                <table className="admin-table">
                    ...
                    {pricingRules.map(rule => (
                        ...
                        <td>
                            <span className={`admin-table__status-badge ${rule.isActive ? 'active' : 'inactive'}`}>
                ...
                <div className="admin-modal" onClick={e => e.stopPropagation()}>
                    ...
                    <div className="admin-form__row">
                        ...
                        <select
                            ...
                            onChange={(e) => setFormData({...formData, ruleType: e.target.value as UIPricingRule['ruleType']})}
                            required
                        >
            ...
            <div className="admin-content__body">
                ...
                <table className="admin-table">
                    ...
                    {constraints.map(constraint => (
                        ...
                        <td>
                            <span className={`admin-table__status-badge ${constraint.isActive ? 'active' : 'inactive'}`}>
            ...
            {isModalOpen && (
                ...
                <div className="admin-modal" onClick={e => e.stopPropagation()}>
                    ...
                    <div className="admin-form__group">
                        ...
                        onChange={(e) => setFormData({...formData, constraintType: e.target.value as UIConstraintRule['constraintType']})}
                        required
                        >
