  ...
  return (
    <div className="admin-dashboard">
      ...
      <header className="admin-dashboard__header">
        <div>
          <h1 className="admin-dashboard__title">🛠️ Marcus's Bicycle Shop Admin</h1>
          <p className="admin-dashboard__subtitle">Manage products, pricing, and business rules</p>
        </div>
        {onBackToCustomer && (
          <button
      ...
      <main className="admin-dashboard__main">{renderTabContent()}</main>
    </div>
  );
}
