...
export function ProductManager() {
    ...
    return (
        ...
        {loading && (
            <div className="admin-content__loading">Loading products...</div>
        )}
            ...
            <div className="admin-table-container">
                ...
                <tbody>
                    ...
                    <tr key={product.id}>
                        ...
                        <td className="admin-table__cell--description">
                        {product.description}
                        </td>
                        <td className="admin-table__cell--price">
        ...
        <div className="admin-modal__content">
            ...
            <div className="admin-form__group admin-form__group--checkbox">
                ...
                <input
                    ...
                    disabled={loading}
                />
                <span className="admin-form__checkbox-text">
                    Product is active
                </span>
                </label>
            </div>
